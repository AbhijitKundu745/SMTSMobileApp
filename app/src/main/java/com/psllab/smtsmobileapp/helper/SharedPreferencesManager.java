...
public class SharedPreferencesManager {
    ...
    private static final String SHARED_PREF_NAME = "SEUIC_LAUNDARY_ASSET_SHARED_PREF";
    ...
    public static int getPower(Context context) {
        return getSharedPreferences(context).getInt(SAVED_POWER, 15);
    }
    ...
    public static String getHostUrl(Context context) {
        return getSharedPreferences(context).getString(HOST_URL, "https://kineco-dev.azurewebsites.net/");
    }
    ...
    public static String getSavedUserId(Context context) {
        return getSharedPreferences(context).getString(LOGIN_USER_ID, "1");
    }
